...
//FIXME: docs. larsivi 20020603

#include "SoQtSuperCanvas.h"
#include "SoQtSuperCanvasP.h"
...
QWidget *
SoQtSuperCanvas::buildWidget(QWidget * parent)
{
  ...
  PRIVATE(this)->canvas = SoQtViewer::buildWidget(PRIVATE(this)->viewerwidget);
