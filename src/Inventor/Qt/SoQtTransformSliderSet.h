...
#ifndef __SOQTTRANSFORMSLIDERSET_H__
#define __SOQTTRANSFORMSLIDERSET_H__

#include <Inventor/Qt/SoQtSliderSet.h>

class SoQtTransformSliderSet : public SoQtSliderSet
{
...
#endif // !__SOQTTRANSFORMSLIDERSET_H__
