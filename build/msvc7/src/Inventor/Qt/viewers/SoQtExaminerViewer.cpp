...
// src/Inventor/Qt/viewers/SoQtExaminerViewer.cpp.  Generated from SoGuiExaminerViewer.cpp.in by configure.
...
/*!
  \fn SoQtExaminerViewer::SoQtExaminerViewer(QWidget * parent, const char * name, SbBool embed, SoQtFullViewer::BuildFlag flag, SoQtViewer::Type type)
...
/*!
  \fn SoQtExaminerViewer::SoQtExaminerViewer(QWidget * parent, const char * name, SbBool embed, SoQtFullViewer::BuildFlag flag, SoQtViewer::Type type, SbBool build)
...
SoGuiExaminerViewerP::setMode(const ViewerMode newmode)
{
  ...
  if (oldmode == ZOOMING) {
    ...
    SoDebugError::postInfo("SoQtExaminerViewerP::setMode",
