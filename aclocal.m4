...
# Usage:
#  SIM_CHECK_QT([ACTION-IF-FOUND [, ACTION-IF-NOT-FOUND]])
#
...
# Usage:
#  SIM_CHECK_QGL([ACTION-IF-FOUND [, ACTION-IF-NOT-FOUND]])
#
#  Try to find the QGL extension library. If it is found, these
#  shell variables are set:
#
